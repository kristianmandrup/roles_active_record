...
In the near future I will make this an option in the configuration DSL somehow. Alternatively you can use the Roles generator, which now generates the Role classes
and place them in app/models of your Rails app.
